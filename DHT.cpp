 ...
 */
double DHT::readTemperature(bool S, bool force) {
  double f = NAN;
 ...
 */
double DHT::convertCtoF(double c) { return c * 1.8 + 32; }
 ...
 */
double DHT::convertFtoC(double f) { return (f - 32) * 0.55555; }

/*!
 *  @brief  Read Humidity
 *  @param  force
 *					force read mode
 *	@return double value - humidity in percent
 */
double DHT::readHumidity(bool force) {
  double f = NAN;
  if (read(force)) {
    switch (_type) {
    case DHT11:
 ...
 */
double DHT::computeHeatIndex(bool isFahrenheit) {
  double hi = computeHeatIndex(readTemperature(isFahrenheit), readHumidity(),
                              isFahrenheit);
  return hi;
}
 ...
 *	@return double heat index
 */
double DHT::computeHeatIndex(double temperature, double percentHumidity,
                            bool isFahrenheit) {
  double hi;
